...
ap=argparse.ArgumentParser();ap.add_argument('source');ap.add_argument('--out',default='experiments/performance/network-and-load');ap.add_argument('--rollout-source');ap.add_argument('--performance-only',action='store_true');a=ap.parse_args()
